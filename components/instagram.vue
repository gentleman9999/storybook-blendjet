      ...
      testimonials: [
        ...
        },
        {
        ...
        },
         {
          ...
          text: '"Love my Blendjet!! It is quiet enough for me to use at work and so easy to clean and travel with. Not only that, but customer service was AMAZING!!"',
          author: 'Cheyenne L.'
        },{
          text: '"Purchased this for my daughter as a gift and I love the convenience it offers her! She’s an athlete so she’s always blending some magical concoction and this makes it so easy!"',
          author: 'Michele C.'
        },{  
          text: '"I hate the big obnoxious blenders so I bought this hoping it would make me want to make meal replacement smoothies more often. And... it did! Literally a life changer!"',
          author: 'Jasmine W.'
        },{  
          ...
          text: '"We love our BlendJet 2. It is very quiet and mixes all ingredients til completely smooth. We use it for mixed drinks such as margaritas, daiquiris, and smoothies. Can not wait to use it on the river!"',
          author: 'Darlene K.'
        },{  
          text: '"This thing is amazing! The BlendJet One was great but this little beast takes it to the next level! Keep it coming BlendJet, can not wait to see what you come up with next!"',
          author: 'Chris H.'
        },{  
          text: '"The BlendJet 2 is incredible. Insanely powerful. Blends my morning protein powder + banana + pb + ice no problem!"',
          author: 'Matt B.'
        }
      ]
    }
