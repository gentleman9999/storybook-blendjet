         ...
         <div class="product-select__controls__extend-warranty" v-if="extend1yr && extend2yr && extend3yr">
              ...
              <div class="product-select__controls__extend-warranty__button-group">
                <div role="buton"
                  ...
                  :class="[warrantySelected.handle === '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-1y' ? 'extend-active' : 'extend-inactive']"
                ...
                <div role="buton"
                  class="product-select__controls__extend-warranty__button"
                  :class="warrantySelected.handle === '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-2y' ? 'extend-active' : 'extend-inactive'"
                ...
                <div role="buton"
                  class="product-select__controls__extend-warranty__button"
                  :class="warrantySelected.handle ===  '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-3y' ? 'extend-active' : 'extend-inactive'"
...
export default {
  ...
  async mounted() {
    if(process.client) {
      ...
      this.extend1yr = await this.$nacelle.data.product({handle: '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-1y'})
      this.extend2yr = await this.$nacelle.data.product({handle: '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-2y'})
      this.extend3yr = await this.$nacelle.data.product({handle: '8862eff0-e8c2-47bc-a194-157f853043ec-10001-blendjet-adh-replace-3y'})
