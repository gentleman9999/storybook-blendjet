            ...
            <div class="card-content" >
              <div class="content">
                <div class="jetpack-purchase">
                  <div class="is-6 jetpack-title" :style="titleStyle" @click="$router.push(`/products/${props.list.handle}`)">{{ formatTitle(props.list.title)}}</div>
                  <div class="rating">
                    <loox-product-rating :product="props.list" />
                  </div>
                  <div class="category">
                  ...
                  <div class="add-to-cart">
                    ...
                    <div class="add-to-cart__add-button">
                      <SubscriptionAddToCartButton
                        :product="props.list"
                        :variant="props.list.variants[0]"
                        :metafields="props.list.metafields"
                    ...
                    <div class="subscribe-select">
                        <SubscriptionToggle 
                          :product="props.list"
                          :variant="props.list.variants[0]"
                          :metafields.sync="props.list.metafields"
...
export default {
  ...
  methods: {
      ...
      openRechargeModal() {
        this.$modal.show(RechargeModal, {height: 'auto',  adaptive: true, scrollable:false})
      },
      setWidthData() {
