<template>
  <div class="blendjet-container" v-if="product">
    <div class="text-block">
            <a href="/products/jetsetter-insulated-sleeve" style="color:white;">Jetsetter Insulated Sleeve</a><br/> <span style="font-size: 75%;color:gold;">10% off 1 - 15% off 2 - 20% off 3+</span>    </div>
