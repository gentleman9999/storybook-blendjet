<template>
  <div class="jetpack-container" v-if="product && jetpacks">
    <div class="text-block">
                               <a href="/products/banana-blueberry-jetpack-ready-to-blend-smoothie" style="color:white;">Try JetPack Variety Pack</a><br/> <span style="font-size: 75%;color:gold;">5 Ready-to-Blend Smoothies</span>
    </div>
