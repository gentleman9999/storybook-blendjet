        ...
        <template slot="item" slot-scope="props">
          <div class="card" :style="cardStyle">
            <div
              ...
              :style="{
                backgroundImage: getBGColor(props.list.title),
                height: '440px',
                cursor: 'pointer'
              }"
            >
  ...
  async mounted() {
    ...
    this.jetpacks = await this.$nacelle.data
      ...
      .then(product => {
        ...
        // Map in some additional data to each variant (product title, url, etc)
        const enhancedVariants = availableVariants.map(v => {
        ...
        vm.showIndicator(enhancedVariants)

        // Return enhanced variants array
