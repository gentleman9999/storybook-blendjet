            ...
            <div class="product-select__controls__value-props">
              ...
              <div class="product-select__controls__value-props__badges">
                ...
                >
                  <img
                    :src="
                      optimizeSource({ url: '/images/blendjetPDP/BBB-Seal.svg' })
                    "
...
export default {
  data() {
    return {
      ...
      description: {},
      client: null,
      jetpackCategory: 'Jetpack Protein Smoothie',
  ...
  methods: {
    ...
    getPageHandle(title) {
      ...
      handle = handle + '-protein-smoothie'
  ...
  async mounted() {
    ...
    // TODO we should get this using nacelle content
    await this.client
      .getEntry('24QNVJ9UR9oYvUmQ8EzvFs')
      .then( async entry => {
