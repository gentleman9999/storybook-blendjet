          ...
          <div class="blendjet-logo" v-if="location === 'collection'">
            ...
            <svg width="140px" height="35px" viewBox="0 0 140 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <g id="Collections" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="JetPackLogo" transform="translate(-650.000000, -256.000000)" filter="url(#filter-1)">
                        <g transform="translate(720.000000, 273.500000) rotate(180.000000) translate(-720.000000, -273.500000) translate(650.000000, 256.000000)">
