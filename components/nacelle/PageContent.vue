  ...
  computed: {
    ...
    body() {
      if (this.page) {
        ...
        if (source === 'contentful' && this.page.fields && this.page.fields.body) {
      ...
      for (let i = keys.length; i--;) {
        ...
        switch (key) {
          ...
          case 'content':
            ...
            break
          case 'slides':
            data[key] = data[key].map(({ fields: { name, quotation, featuredMedia } }) => ({
              name,
              quote: quotation,
            ...
            break
          case 'children':
            data.slides = data[key].map(({ data: { title, contentHtml, image } }) => ({
              name: title,
              quote: contentHtml,
