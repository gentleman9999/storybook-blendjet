<template>
  ...
  <div class="pdp-container" v-if="product && jetpacks.length">
          ...
          <div class="product-select__controls__add-to-cart">
            <div class="product-select__controls__add-to-cart__subscribe-select">
              <SubscriptionToggle
                ...
                />
              <div class="product-select__controls__add-to-cart__subscribe-select__about" @click="$modal.show('about-subscriptions')">
            ...
            <div class="product-select__controls__add-to-cart__quantity-add-button">
              ...
              <div class="product-select__controls__add-to-cart__quantity-add-button__quantity__add-to-cart">
            ...
            <div class="about-subscriptions__column">
              <div class="about-subscriptions__icon">
                <svg width="70px" height="70px" viewBox="0 0 70 70" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>Group 2</title>
                    <defs>
                      <linearGradient x1="50%" y1="0%" x2="50%" y2="98.7331081%" id="linearGradient-1">
                        <stop stop-color="#1E90BB" offset="0%"></stop>
                        <stop stop-color="#373795" offset="100%"></stop>
                      </linearGradient>
                    </defs>
                    <g id="PDP" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="D-BlendJet-PDP-JetPack-Copy" transform="translate(-685.000000, -289.000000)">
                        <g id="Group-4" transform="translate(472.000000, 170.000000)">
                          <g id="Portable" transform="translate(113.000000, 120.000000)">
                            <g id="Group-2" transform="translate(101.000000, 0.000000)">
                              <circle id="Oval-Copy" stroke="#373795" stroke-width="1.5" cx="34" cy="34" r="34"></circle>
                              <circle id="Oval-Copy" fill="url(#linearGradient-1)" cx="34" cy="34" r="30"></circle>
                              <text id="30" font-family="Helvetica" font-size="26" font-weight="normal" line-spacing="14" fill="#FFFFFF">
                                <tspan x="19" y="37">30</tspan>
                              </text>
                              <text id="DAYS" font-family="Helvetica" font-size="11" font-weight="normal" line-spacing="14" fill="#FFFFFF">
              ...
              <div class="about-subscriptions__icon">
                <svg width="70px" height="70px" viewBox="0 0 70 70" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <g id="PDP" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="D-BlendJet-PDP-JetPack-Copy" transform="translate(-685.000000, -438.000000)">
                        <g id="Group-4" transform="translate(472.000000, 170.000000)">
                          <g id="Portable-Copy" transform="translate(113.000000, 269.000000)">
                            <g id="Group-2" transform="translate(101.000000, 0.000000)">
                              <circle id="Oval-Copy" stroke="#373795" stroke-width="1.5" cx="34" cy="34" r="34"></circle>
                              <circle id="Oval-Copy" fill="url(#linearGradient-1)" cx="34" cy="34" r="30"></circle>
                              <path d="M44.16,22.2928932 L45.7071068,23.84 L36.0471068,33.5 L45.7071068,43.16 L44.1599817,44.7071251 L34.5,35.0461434 L24.8400183,44.7071251 L23.2929115,43.1600183 L32.9528932,33.4990366 L23.2928749,23.8400183 L24.84,22.2928932 L34.5,31.9528932 L44.16,22.2928932 Z" id="Ham___Mobile_2" stroke="#FFFFFF" fill="#FFFFFF" stroke-linejoin="round"></path>
                            </g>
                          </g>
                        </g>
                      </g>
    ...
    <div class="media-content">
      ...
      <div class="media-content__main" v-if="page && page.fields.features">
        <div class="media-content__main__features">
          <JetpackFeaturesPDP
            :content="page.fields.features.fields.description"
            :title="page.fields.features.fields.title"
          />
        </div>
        <div class="media-content__main__details" v-if="loaded && page && page.fields.productDescription">


          <div v-for="(section, i) of page.fields.productDescription" :key="i" class="media-content__main__details__content-block">
    ...
    <div class="jetpacks">
      <JetpackCrossSell :jetpacks="jetpacks" :heading="'You may also like these jetpack flavors'" />
    </div>
...
export default {
  ...
  methods: {
    ...
    updateJetpack(jetpack) {
      this.$router.push(`/products/${jetpack.handle}`)
    },
    toggleJetpackMenu() {
  ...
  async mounted() {
    ...
    console.log(this.page)
     ...
     const vm = this
      await this.client.getEntry('6L3Tl2qpSUZLV3i2I3thFQ')
          .then((entry) => {
            ...
            this.productImage = this.media[this.camelize(this.formatTitle(this.product.title))].productImage;
            this.heroImages = this.media[this.camelize(this.formatTitle(this.product.title))].heroImages;
            this.bannerText = this.media[this.camelize(this.formatTitle(this.product.title))].bannerText;
            this.loaded = true
