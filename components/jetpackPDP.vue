    ...
    <div class="pdp-container" v-if="product && jetpacks.length">
      <div class="product-select">
        ...
        <div class="product-select__controls__mobile-title-container">
          <a href="/products/jetpack-protein-smoothie"
            ><div
              class="inner-text"
        ...
        <div class="product-select__image-carousel">
          <transition name="fade" mode="out-in">
            <img
              ...
              :src="optimizeSource({ url: productImage, size: 2100 })"
            />
          </transition>
        </div>
          ...
          <div class="product-select__controls__container">
            ...
            <div class="product-select__controls__option-select">
              <div class="jetpack-dropdown-container">
                <JetpackDropdown :items="jetpacks" :product="productData" @update="updateJetpack" />
              </div>
            </div>
      ...
      <div class="media-content">
        ...
        <div class="media-content__main" v-if="page && page.fields.features">
          ...
          <div
            ...
            v-if="loaded && page && page.fields.productDescription"
          >
            <div
              v-for="(section, i) of page.fields.productDescription"
              :key="i"
            ...
            >
              ...
              >
                <img
                  ...
                  :src="optimizeSource({ url: section.fields.video.fields.file.url })"
                />
              </div>
            </div>
          </div>
  ...
  async mounted() {
    ...
    await this.client
      ...
      .then(entry => {
        ...
        this.productImage = this.media[
          this.camelize(this.formatTitle(this.product.title))
        ].productImage
