<template>
  <div class="blendjet-container" v-if="product">
    <div class="text-block">
            <a href="/products/recipe-book" style="color:white;">NEW BlendJet Recipe Book</a><br/> <span style="font-size: 75%;color:gold;">50 Amazing Recipes + Hardcover</span>
    </div>
...
export default {
  ...
  async mounted() {
    this.product = await this.$nacelle.data.product({handle: 'recipe-book'})
