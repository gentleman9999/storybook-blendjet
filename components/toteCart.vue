<template>
  <div class="blendjet-container" v-if="product">
    <div class="text-block">
            <a href="/products/jetsetter-insulated-tote" style="color:white;">Jetsetter Insulated Tote</a><br/> <span style="font-size: 75%;color:gold;">15% off 1 - 20% off 2 - 25% off 3+</span>
    </div>
